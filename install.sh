...
echo ""
echo "  3. Set CrofAI as your default provider:"
echo "     hermes config set model.provider crofai"
echo "     hermes config set model.default deepseek-v4-flash"
echo ""
echo "  4. Start Hermes with the persistent usage widget:"
echo "     hermes crof"
echo ""
echo "  5. Or use /crofai in any Hermes session for on-demand usage stats."
